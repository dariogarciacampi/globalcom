...
<body> 
	...
	<div class="container">
			<?php 
				...
				$mensaje = "Compra satisfactoria de: ".$_SESSION['name'].". Email: ".$_SESSION['email']."";
					
					mail('gc.globalcom@gmail.com', 'Consulta Web', $mensaje);


					// El mensaje
					$mensaje = "Su compra se ha realizado con exito, en las proximas horas estaremos procesando la misma. \r\n Muchas gracias por su confianza. \r\n Atte. GlobalCom - gc.globalcom@gmail.com";

					// Si cualquier línea es más larga de 70 caracteres, se debería usar wordwrap()
					//$mensaje = wordwrap($mensaje, 70, "\r\n");
					
					// Send
					mail($_SESSION['email'], 'Compra Web', $mensaje);


					echo "<div class='alert alert-success'>Su compra se ha realizado con exito en las proximas horas le estaremos enviando el detalle dela misma.</div>" ;
