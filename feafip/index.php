...
$regfe['ImpNeto']=94.65;			// neto gravado
$regfe['ImpTotConc']=0;			// no gravado
$regfe['ImpIVA']=9.94;			// IVA liquidado
$regfe['ImpTrib']=0;			// otros tributos
$regfe['ImpOpEx']=0;			// operacion exentas
$regfe['ImpTotal']=104.59;			// total de la factura. ImpNeto + ImpTotConc + ImpIVA + ImpTrib + ImpOpEx
...
// Detalle de iva
$regfeiva['Id'] = 4; 
$regfeiva['BaseImp'] = 94.65; 
$regfeiva['Importe'] = 9.94;
