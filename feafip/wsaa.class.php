...
class WSAA {
	...
	const CERT = "keys/globalcom.crt";        	# The X.509 certificate in PEM format. Importante setear variable $path
	const PRIVATEKEY = "keys/globalcom.key";  	# The private key correspoding to CERT (PEM). Importante setear variable $path
